...
# %% auto 0
__all__ = ['train_sources', 'path', 'k', 'min_words', 'max_words', 'max_links', 'ignore_text', 'ignore_common',
           'ignore_filenames', 'Webpage', 'get_common_english_words', 'get_page_all', 'get_all_links', 'process_data']
