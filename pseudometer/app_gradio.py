# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_app_gradio.ipynb.

# %% auto 0
__all__ = ['categories', 'k', 'min_words', 'max_words', 'ignore_text', 'ignore_common', 'examples', 'pseudo_sources',
           'science_sources', 'predict']

# %% ../nbs/03_app_gradio.ipynb 3
import warnings
